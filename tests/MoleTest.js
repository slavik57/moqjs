...
(function (Tests) {
    ...
    QUnit.test('noArgumentsFunction - should call only the original function', function (assert) {
        QUnit.expect(1);
        var context = this;
        var shouldNotBeCalled = function () { return assert.ok(false, 'should not be called'); };
    ...
    QUnit.test('getter - should call only the original getter', 2, function (assert) {
        ...
        context.testObject.onGetterOfGetterAndSetterCalled = shouldNotBeCalled;
        context.testObject.onSetterCalled = shouldNotBeCalled;
        context.testObject.onGetterCalled = function () { return assert.ok(true, 'should call the getter'); };
        var value = {};
    ...
    QUnit.test('setter - should call only the original setter', 2, function (assert) {
        ...
        context.testObject.onGetterOfGetterAndSetterCalled = shouldNotBeCalled;
        context.testObject.onGetterCalled = shouldNotBeCalled;
        context.testObject.onSetterCalled = function () { return assert.ok(true, 'should call the getter'); };
        var value = {};
    ...
    QUnit.test('getter&setter - setter - should call only the original setter', 2, function (assert) {
        ...
        context.testObject.onGetterOfGetterAndSetterCalled = shouldNotBeCalled;
        context.testObject.onGetterCalled = shouldNotBeCalled;
        context.testObject.onSetterOfGetterAndSetterCalled = function () { return assert.ok(true, 'should call the getter'); };
        var value = {};
    ...
    QUnit.test('getter&setter - getter - should call only the original getter', 2, function (assert) {
        ...
        context.testObject.onSetterOfGetterAndSetterCalled = shouldNotBeCalled;
        context.testObject.onGetterCalled = shouldNotBeCalled;
        context.testObject.onGetterOfGetterAndSetterCalled = function () { return assert.ok(true, 'should call the getter'); };
        var value = {};
    ...
    QUnit.test('verify - should verify only the no arguments function', 7, function (assert) {
        ...
        var arg3 = {};
        context.testObject.noArgumentsFunction();
        var verifyNoArguments = context.mole.verify(function (_) { return _.noArgumentsFunction(); });
        var verifyOneArguments = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg1); });
        var verifyManyArguments = context.mole.verify(function (_) { return _.manyArgumentsFunction(arg1, arg2, arg3); });
        var verifyGetter = context.mole.verify(function (_) { return _.getter; });
        var verifySetter = context.mole.verify(function (_) { return _.setter = arg1; });
        var verifyGetterAndSetterGetter = context.mole.verify(function (_) { return _.getterAndSetter; });
        var verifyGetterAndSetterSetter = context.mole.verify(function (_) { return _.getterAndSetter = arg1; });
    ...
    QUnit.test('verify - no arguments - was not called should not find a match', function (assert) {
        QUnit.expect(1);
        var context = this;
        var result = context.mole.verify(function (_) { return _.noArgumentsFunction(); });
    ...
    QUnit.test('verify - no arguments - was not called should not find 2 matches', function (assert) {
        QUnit.expect(1);
        var context = this;
        var result = context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(2));
        assert.strictEqual(result, false, 'should not be verified');
    });
    QUnit.test('verify - no arguments - was not called should return true on 0 matches', function (assert) {
        QUnit.expect(1);
        var context = this;
        var result = context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(0));
    ...
    QUnit.test('verify - no arguments - was called should return true on 1 matches', function (assert) {
        ...
        var context = this;
        context.testObject.noArgumentsFunction();
        var result = context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(1));
    ...
    QUnit.test('verify - no arguments - was called twice should return false on 3 matches', function (assert) {
        ...
        context.testObject.noArgumentsFunction();
        context.testObject.noArgumentsFunction();
        var result = context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(3));
        assert.strictEqual(result, false, 'should not be verified');
    });
    QUnit.test('verify - one argument - was not called should not find a match', function (assert) {
        ...
        var context = this;
        var arg = {};
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg); });
    ...
    QUnit.test('verify - one argument - was not called should not find 1 match', function (assert) {
        ...
        var context = this;
        var arg = {};
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg); }, Times.exact(1));
        assert.strictEqual(result, false, 'should not find a match');
    });
    QUnit.test('verify - one argument - was not called should not find 2 matches', function (assert) {
        ...
        var context = this;
        var arg = {};
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg); }, Times.exact(2));
        assert.strictEqual(result, false, 'should not find a match');
    });
    QUnit.test('verify - one argument - was not called should find 0 matches', function (assert) {
        ...
        var context = this;
        var arg = {};
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg); }, Times.exact(0));
    ...
    QUnit.test('verify - one argument - was called twice should not find 3 matches', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg);
        context.testObject.oneArgumentsFunction(arg);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg); }, Times.exact(3));
    ...
    QUnit.test('verify - one argument - was called twice should verify first arg', function (assert) {
        ...
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg1); });
    ...
    QUnit.test('verify - one argument - was called twice should verify first arg called 1 time', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg1);
        context.testObject.oneArgumentsFunction(arg2);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg1); }, Times.exact(1));
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - one argument - was called twice should not verify first arg called 0 times', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg1);
        context.testObject.oneArgumentsFunction(arg2);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg1); }, Times.exact(0));
    ...
    QUnit.test('verify - one argument - was called twice should not verify first arg called 2 times', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg1);
        context.testObject.oneArgumentsFunction(arg2);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg1); }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    ...
    QUnit.test('verify - one argument - was called twice should verify second arg was called', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg1);
        context.testObject.oneArgumentsFunction(arg2);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg2); });
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - one argument - was called twice should verify second arg was called 1 time', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg1);
        context.testObject.oneArgumentsFunction(arg2);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg2); }, Times.exact(1));
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - one argument - was called twice should not verify second arg was called 2 times', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg1);
        context.testObject.oneArgumentsFunction(arg2);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg2); }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - one argument - was called twice should not verify second arg was called 0 times', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg1);
        context.testObject.oneArgumentsFunction(arg2);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg2); }, Times.exact(0));
        assert.strictEqual(result, false, 'should not verify');
    });
    ...
    QUnit.test('verify - one argument - was called 3 times should not verify second arg was called 3 times', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg2);
        context.testObject.oneArgumentsFunction(arg2);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg2); }, Times.exact(3));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - one argument - was called twice should not verify with another arg', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg1);
        context.testObject.oneArgumentsFunction(arg2);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg3); });
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - one argument - was called twice should not verify with another arg was called 1 times', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg1);
        context.testObject.oneArgumentsFunction(arg2);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg3); }, Times.exact(1));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - one argument - was called twice should not verify with another arg was called 2 times', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg1);
        context.testObject.oneArgumentsFunction(arg2);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg3); }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - one argument - was called twice should verify with another arg was called 0 times', function (assert) {
        ...
        context.testObject.oneArgumentsFunction(arg1);
        context.testObject.oneArgumentsFunction(arg2);
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(arg3); }, Times.exact(0));
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - many arguments - was not called should not verify', function (assert) {
        ...
        var arg2 = {};
        var arg3 = {};
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(arg1, arg2, arg3); });
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - many arguments - was not called should not verify for 1 time', function (assert) {
        ...
        var arg2 = {};
        var arg3 = {};
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(arg1, arg2, arg3); }, Times.exact(1));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - many arguments - was not called should not verify for 2 times', function (assert) {
        ...
        var arg2 = {};
        var arg3 = {};
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(arg1, arg2, arg3); }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - many arguments - was not called should verify for 0 times', function (assert) {
        ...
        var arg2 = {};
        var arg3 = {};
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(arg1, arg2, arg3); }, Times.exact(0));
        assert.strictEqual(result, true, 'should verify');
    });
    ...
    QUnit.test('verify - many arguments - was called twice should not verify for 3 times', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(arg1, arg2, arg3);
        context.testObject.manyArgumentsFunction(arg1, arg2, arg3);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(arg1, arg2, arg3); }, Times.exact(3));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - many arguments -  was called twice with different sets should verify first set', function (assert) {
        ...
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]); });
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - many arguments -  was called twice with different sets should verify first set 1 time', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]);
        context.testObject.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]); }, Times.exact(1));
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - many arguments -  was called twice with different sets should not verify first set 0 times', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]);
        context.testObject.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]); }, Times.exact(0));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - many arguments -  was called twice with different sets should not verify first set 2 times', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]);
        context.testObject.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]); }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - many arguments -  was called twice with different sets should verify second set', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]);
        context.testObject.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]); });
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - many arguments -  was called twice with different sets should verify second set 1 time', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]);
        context.testObject.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]); }, Times.exact(1));
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - many arguments -  was called twice with different sets should not verify second set 0 times', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]);
        context.testObject.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]); }, Times.exact(0));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - many arguments -  was called twice with different sets should not verify second set 2 times', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]);
        context.testObject.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]); }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - many arguments -  was called twice with different sets should not verify another set', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]);
        context.testObject.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet1[0], argSet1[1], argSet2[2]); });
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - many arguments -  was called twice with different sets should not verify another set 1 time', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]);
        context.testObject.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet1[0], argSet1[1], argSet2[2]); }, Times.exact(1));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - many arguments -  was called twice with different sets should not verify another set 2 times', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]);
        context.testObject.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet1[0], argSet1[1], argSet2[2]); }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - many arguments -  was called twice with different sets should verify another set 0 times', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(argSet1[0], argSet1[1], argSet1[2]);
        context.testObject.manyArgumentsFunction(argSet2[0], argSet2[1], argSet2[2]);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet1[0], argSet1[1], argSet2[2]); }, Times.exact(0));
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - getter - was not called should not find a match', function (assert) {
        QUnit.expect(1);
        var context = this;
        var result = context.mole.verify(function (_) { return _.getter; });
        assert.strictEqual(result, false, 'should not be verified');
    });
    QUnit.test('verify - getter - was not called should not find 2 matches', function (assert) {
        QUnit.expect(1);
        var context = this;
        var result = context.mole.verify(function (_) { return _.getter; }, Times.exact(2));
        assert.strictEqual(result, false, 'should not be verified');
    });
    QUnit.test('verify - getter - was not called should return true on 0 matches', function (assert) {
        QUnit.expect(1);
        var context = this;
        var result = context.mole.verify(function (_) { return _.getter; }, Times.exact(0));
        assert.strictEqual(result, true, 'should verified');
    });
    ...
    QUnit.test('verify - getter - was called should return true on 1 matches', function (assert) {
        ...
        var context = this;
        var value = context.testObject.getter;
        var result = context.mole.verify(function (_) { return _.getter; }, Times.exact(1));
        assert.strictEqual(result, true, 'should be verified');
    });
    ...
    QUnit.test('verify - getter - was called twice should return false on 3 matches', function (assert) {
        ...
        var value1 = context.testObject.getter;
        var value2 = context.testObject.getter;
        var result = context.mole.verify(function (_) { return _.getter; }, Times.exact(3));
        assert.strictEqual(result, false, 'should not be verified');
    });
    QUnit.test('verify - setter - was not called should not find a match', function (assert) {
        ...
        var context = this;
        var arg = {};
        var result = context.mole.verify(function (_) { return _.setter = arg; });
        assert.strictEqual(result, false, 'should not find a match');
    });
    QUnit.test('verify - setter - was not called should not find 1 match', function (assert) {
        ...
        var context = this;
        var arg = {};
        var result = context.mole.verify(function (_) { return _.setter = arg; }, Times.exact(1));
        assert.strictEqual(result, false, 'should not find a match');
    });
    QUnit.test('verify - setter - was not called should not find 2 matches', function (assert) {
        ...
        var context = this;
        var arg = {};
        var result = context.mole.verify(function (_) { return _.setter = arg; }, Times.exact(2));
        assert.strictEqual(result, false, 'should not find a match');
    });
    QUnit.test('verify - setter - was not called should find 0 matches', function (assert) {
        ...
        var context = this;
        var arg = {};
        var result = context.mole.verify(function (_) { return _.setter = arg; }, Times.exact(0));
        assert.strictEqual(result, true, 'should find 0 matches');
    });
    ...
    QUnit.test('verify - setter - was called twice should not find 3 matches', function (assert) {
        ...
        context.testObject.setter = arg;
        context.testObject.setter = arg;
        var result = context.mole.verify(function (_) { return _.setter = arg; }, Times.exact(3));
        assert.strictEqual(result, false, 'should not verify 3 matches');
    });
    QUnit.test('verify - setter - was called twice should verify first arg', function (assert) {
        ...
        var result = context.mole.verify(function (_) { return _.setter = arg1; });
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - setter - was called twice should verify first arg called 1 time', function (assert) {
        ...
        context.testObject.setter = arg1;
        context.testObject.setter = arg2;
        var result = context.mole.verify(function (_) { return _.setter = arg1; }, Times.exact(1));
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - setter - was called twice should not verify first arg called 0 times', function (assert) {
        ...
        context.testObject.setter = arg1;
        context.testObject.setter = arg2;
        var result = context.mole.verify(function (_) { return _.setter = arg1; }, Times.exact(0));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - setter - was called twice should not verify first arg called 2 times', function (assert) {
        ...
        context.testObject.setter = arg1;
        context.testObject.setter = arg2;
        var result = context.mole.verify(function (_) { return _.setter = arg1; }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    ...
    QUnit.test('verify - setter - was called twice should verify second arg was called', function (assert) {
        ...
        context.testObject.setter = arg1;
        context.testObject.setter = arg2;
        var result = context.mole.verify(function (_) { return _.setter = arg2; });
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - setter - was called twice should verify second arg was called 1 time', function (assert) {
        ...
        context.testObject.setter = arg1;
        context.testObject.setter = arg2;
        var result = context.mole.verify(function (_) { return _.setter = arg2; }, Times.exact(1));
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - setter - was called twice should not verify second arg was called 2 times', function (assert) {
        ...
        context.testObject.setter = arg1;
        context.testObject.setter = arg2;
        var result = context.mole.verify(function (_) { return _.setter = arg2; }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - setter - was called twice should not verify second arg was called 0 times', function (assert) {
        ...
        context.testObject.setter = arg1;
        context.testObject.setter = arg2;
        var result = context.mole.verify(function (_) { return _.setter = arg2; }, Times.exact(0));
        assert.strictEqual(result, false, 'should not verify');
    });
    ...
    QUnit.test('verify - setter - was called 3 times should not verify second arg was called 3 times', function (assert) {
        ...
        context.testObject.setter = arg2;
        context.testObject.setter = arg2;
        var result = context.mole.verify(function (_) { return _.setter = arg2; }, Times.exact(3));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - setter - was called twice should not verify with another arg', function (assert) {
        ...
        context.testObject.setter = arg1;
        context.testObject.setter = arg2;
        var result = context.mole.verify(function (_) { return _.setter = arg3; });
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - setter - was called twice should not verify with another arg was called 1 times', function (assert) {
        ...
        context.testObject.setter = arg1;
        context.testObject.setter = arg2;
        var result = context.mole.verify(function (_) { return _.setter = arg3; }, Times.exact(1));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - setter - was called twice should not verify with another arg was called 2 times', function (assert) {
        ...
        context.testObject.setter = arg1;
        context.testObject.setter = arg2;
        var result = context.mole.verify(function (_) { return _.setter = arg3; }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - setter - was called twice should verify with another arg was called 0 times', function (assert) {
        ...
        context.testObject.setter = arg1;
        context.testObject.setter = arg2;
        var result = context.mole.verify(function (_) { return _.setter = arg3; }, Times.exact(0));
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - getter&setter - getter - was not called should not find a match', function (assert) {
        QUnit.expect(1);
        var context = this;
        var result = context.mole.verify(function (_) { return _.getterAndSetter; });
        assert.strictEqual(result, false, 'should not be verified');
    });
    QUnit.test('verify - getter&setter - getter - was not called should not find 2 matches', function (assert) {
        QUnit.expect(1);
        var context = this;
        var result = context.mole.verify(function (_) { return _.getterAndSetter; }, Times.exact(2));
        assert.strictEqual(result, false, 'should not be verified');
    });
    QUnit.test('verify - getter&setter - getter - was not called should return true on 0 matches', function (assert) {
        QUnit.expect(1);
        var context = this;
        var result = context.mole.verify(function (_) { return _.getterAndSetter; }, Times.exact(0));
        assert.strictEqual(result, true, 'should verified');
    });
    ...
    QUnit.test('verify - getter&setter - getter - was called should return true on 1 matches', function (assert) {
        ...
        var context = this;
        var value = context.testObject.getterAndSetter;
        var result = context.mole.verify(function (_) { return _.getterAndSetter; }, Times.exact(1));
        assert.strictEqual(result, true, 'should be verified');
    });
    ...
    QUnit.test('verify - getter&setter - getter - was called twice should return false on 3 matches', function (assert) {
        ...
        var value1 = context.testObject.getterAndSetter;
        var value2 = context.testObject.getterAndSetter;
        var result = context.mole.verify(function (_) { return _.getterAndSetter; }, Times.exact(3));
        assert.strictEqual(result, false, 'should not be verified');
    });
    QUnit.test('verify - getter&setter - setter - was not called should not find a match', function (assert) {
        ...
        var context = this;
        var arg = {};
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg; });
        assert.strictEqual(result, false, 'should not find a match');
    });
    QUnit.test('verify - getter&setter - setter - was not called should not find 1 match', function (assert) {
        ...
        var context = this;
        var arg = {};
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg; }, Times.exact(1));
        assert.strictEqual(result, false, 'should not find a match');
    });
    QUnit.test('verify - getter&setter - setter - was not called should not find 2 matches', function (assert) {
        ...
        var context = this;
        var arg = {};
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg; }, Times.exact(2));
        assert.strictEqual(result, false, 'should not find a match');
    });
    QUnit.test('verify - getter&setter - setter - was not called should find 0 matches', function (assert) {
        ...
        var context = this;
        var arg = {};
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg; }, Times.exact(0));
        assert.strictEqual(result, true, 'should find 0 matches');
    });
    ...
    QUnit.test('verify - getter&setter - setter - was called twice should not find 3 matches', function (assert) {
        ...
        context.testObject.getterAndSetter = arg;
        context.testObject.getterAndSetter = arg;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg; }, Times.exact(3));
        assert.strictEqual(result, false, 'should not verify 3 matches');
    });
    QUnit.test('verify - getter&setter - setter - was called twice should verify first arg', function (assert) {
        ...
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg1; });
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - getter&setter - setter - was called twice should verify first arg called 1 time', function (assert) {
        ...
        context.testObject.getterAndSetter = arg1;
        context.testObject.getterAndSetter = arg2;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg1; }, Times.exact(1));
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - getter&setter - setter - was called twice should not verify first arg called 0 times', function (assert) {
        ...
        context.testObject.getterAndSetter = arg1;
        context.testObject.getterAndSetter = arg2;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg1; }, Times.exact(0));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - getter&setter - setter - was called twice should not verify first arg called 2 times', function (assert) {
        ...
        context.testObject.getterAndSetter = arg1;
        context.testObject.getterAndSetter = arg2;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg1; }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    ...
    QUnit.test('verify - getter&setter - setter - was called twice should verify second arg was called', function (assert) {
        ...
        context.testObject.getterAndSetter = arg1;
        context.testObject.getterAndSetter = arg2;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg2; });
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - getter&setter - setter - was called twice should verify second arg was called 1 time', function (assert) {
        ...
        context.testObject.getterAndSetter = arg1;
        context.testObject.getterAndSetter = arg2;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg2; }, Times.exact(1));
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - getter&setter - setter - was called twice should not verify second arg was called 2 times', function (assert) {
        ...
        context.testObject.getterAndSetter = arg1;
        context.testObject.getterAndSetter = arg2;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg2; }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - getter&setter - setter - was called twice should not verify second arg was called 0 times', function (assert) {
        ...
        context.testObject.getterAndSetter = arg1;
        context.testObject.getterAndSetter = arg2;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg2; }, Times.exact(0));
        assert.strictEqual(result, false, 'should not verify');
    });
    ...
    QUnit.test('verify - getter&setter - setter - was called 3 times should not verify second arg was called 3 times', function (assert) {
        ...
        context.testObject.getterAndSetter = arg2;
        context.testObject.getterAndSetter = arg2;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg2; }, Times.exact(3));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - getter&setter - setter - was called twice should not verify with another arg', function (assert) {
        ...
        context.testObject.getterAndSetter = arg1;
        context.testObject.getterAndSetter = arg2;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg3; });
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - getter&setter - setter - was called twice should not verify with another arg was called 1 times', function (assert) {
        ...
        context.testObject.getterAndSetter = arg1;
        context.testObject.getterAndSetter = arg2;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg3; }, Times.exact(1));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - getter&setter - setter - was called twice should not verify with another arg was called 2 times', function (assert) {
        ...
        context.testObject.getterAndSetter = arg1;
        context.testObject.getterAndSetter = arg2;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg3; }, Times.exact(2));
        assert.strictEqual(result, false, 'should not verify');
    });
    QUnit.test('verify - getter&setter - setter - was called twice should verify with another arg was called 0 times', function (assert) {
        ...
        context.testObject.getterAndSetter = arg1;
        context.testObject.getterAndSetter = arg2;
        var result = context.mole.verify(function (_) { return _.getterAndSetter = arg3; }, Times.exact(0));
        assert.strictEqual(result, true, 'should verify');
    });
    QUnit.test('verify - complex test', function (assert) {
        ...
        context.testObject.manyArgumentsFunction(argSet[0], argSet[1], argSet[0]);
        context.testObject.oneArgumentsFunction(argSet[2]);
        assert.strictEqual(context.mole.verify(function (_) { return _.noArgumentsFunction(); }), true, 'no arguments function should be verified');
        assert.strictEqual(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(0)), false, 'no arguments function should not be verified for 0');
        assert.strictEqual(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(1)), false, 'no arguments function should not be verified for 1');
        assert.strictEqual(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(2)), false, 'no arguments function should not be verified for 2');
        assert.strictEqual(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(3)), false, 'no arguments function should not be verified for 3');
        assert.strictEqual(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(4)), true), 'no arguments function should be verified for 4';
        assert.strictEqual(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(5)), false, 'no arguments function should not be verified for 5');
        assert.strictEqual(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(6)), false, 'no arguments function should not be verified for 6');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[0]); }), true, 'one arguments function should be verified for argSet[0]');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[1]); }), true, 'one arguments function should be verified for argSet[1]');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[2]); }), true, 'one arguments function should be verified for argSet[2]');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[3]); }), false, 'one arguments function should not be verified for argSet[3]');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[0]); }, Times.exact(0)), false, 'one arguments function should not be verified for argSet[0] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[0]); }, Times.exact(1)), false, 'one arguments function should not be verified for argSet[0] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[0]); }, Times.exact(2)), false, 'one arguments function not should be verified for argSet[0] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[0]); }, Times.exact(3)), true, 'one arguments function should be verified for argSet[0] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[0]); }, Times.exact(4)), false, 'one arguments function should not be verified for argSet[0] 4 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[1]); }, Times.exact(0)), false, 'one arguments function should not be verified for argSet[1] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[1]); }, Times.exact(1)), true, 'one arguments function should be verified for argSet[1] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[1]); }, Times.exact(2)), false, 'one arguments function should not be verified for argSet[1] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[1]); }, Times.exact(3)), false, 'one arguments function should not be verified for argSet[1] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[2]); }, Times.exact(0)), false, 'one arguments function should not be verified for argSet[2] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[2]); }, Times.exact(1)), false, 'one arguments function should not be verified for argSet[2] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[2]); }, Times.exact(2)), false, 'one arguments function should not be verified for argSet[2] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[2]); }, Times.exact(3)), true, 'one arguments function should be verified for argSet[2] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[2]); }, Times.exact(4)), false, 'one arguments function should not be verified for argSet[2] 4 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(argSet[2]); }, Times.exact(5)), false, 'one arguments function should not be verified for argSet[2] 5 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[2]); }), true, 'many arguments function should be verified for argSet[0,1,2]');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[2]); }, Times.exact(0)), false, 'many arguments function should not be verified for argSet[0,1,2] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[2]); }, Times.exact(1)), false, 'many arguments function should not be verified for argSet[0,1,2] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[2]); }, Times.exact(2)), false, 'many arguments function should not be verified for argSet[0,1,2] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[2]); }, Times.exact(3)), true, 'many arguments function should be verified for argSet[0,1,2] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[2]); }, Times.exact(4)), false, 'many arguments function should not be verified for argSet[0,1,2] 4 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[2]); }, Times.exact(5)), false, 'many arguments function should not be verified for argSet[0,1,2] 5 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[0]); }), true, 'many arguments function should be verified for argSet[0,1,0]');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[0]); }, Times.exact(0)), false, 'many arguments function should not be verified for argSet[0,1,0] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[0]); }, Times.exact(1)), false, 'many arguments function should not be verified for argSet[0,1,0] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[0]); }, Times.exact(2)), true, 'many arguments function should be verified for argSet[0,1,0] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[0]); }, Times.exact(3)), false, 'many arguments function should not be verified for argSet[0,1,0] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[1], argSet[0]); }, Times.exact(4)), false, 'many arguments function should not be verified for argSet[0,1,0] 4 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[1], argSet[1], argSet[1]); }), true, 'many arguments function should not be verified for argSet[1,1,1]');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[1], argSet[1], argSet[1]); }, Times.exact(0)), false, 'many arguments function should not be verified for argSet[1,1,1] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[1], argSet[1], argSet[1]); }, Times.exact(1)), true, 'many arguments function should be verified for argSet[1,1,1] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[1], argSet[1], argSet[1]); }, Times.exact(2)), false, 'many arguments function should not be verified for argSet[1,1,1] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[1], argSet[1], argSet[1]); }, Times.exact(3)), false, 'many arguments function should not be verified for argSet[1,1,1] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[2], argSet[1], argSet[2]); }), true, 'many arguments function should be verified for argSet[2,1,2]');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[2], argSet[1], argSet[2]); }, Times.exact(0)), false, 'many arguments function should not be verified for argSet[2,1,2] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[2], argSet[1], argSet[2]); }, Times.exact(1)), true, 'many arguments function should be verified for argSet[2,1,2] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[2], argSet[1], argSet[2]); }, Times.exact(2)), false, 'many arguments function should not be verified for argSet[2,1,2] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[2], argSet[1], argSet[2]); }, Times.exact(3)), false, 'many arguments function should not be verified for argSet[2,1,2] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[2], argSet[2], argSet[2]); }), true, 'many arguments function should be verified for argSet[2,2,2]');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[2], argSet[2], argSet[2]); }, Times.exact(0)), false, 'many arguments function should not be verified for argSet[2,2,2] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[2], argSet[2], argSet[2]); }, Times.exact(1)), true, 'many arguments function should be verified for argSet[2,2,2] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[2], argSet[2], argSet[2]); }, Times.exact(2)), false, 'many arguments function should not be verified for argSet[2,2,2] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[2], argSet[2], argSet[2]); }, Times.exact(3)), false, 'many arguments function should not be verified for argSet[2,2,2] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[0], argSet[0]); }), false, 'many arguments function should not be verified for argSet[0,0,0]');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[0], argSet[0]); }, Times.exact(0)), true, 'many arguments function should be verified for argSet[0,0,0] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[0], argSet[0]); }, Times.exact(1)), false, 'many arguments function should not be verified for argSet[0,0,0] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[0], argSet[0]); }, Times.exact(2)), false, 'many arguments function should not be verified for argSet[0,0,0] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.manyArgumentsFunction(argSet[0], argSet[0], argSet[0]); }, Times.exact(3)), false, 'many arguments function should not be verified for argSet[0,0,0] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getter; }), true, 'getter should be verified');
        assert.strictEqual(context.mole.verify(function (_) { return _.getter; }, Times.exact(0)), false, 'getter should not be verified for 0');
        assert.strictEqual(context.mole.verify(function (_) { return _.getter; }, Times.exact(1)), false, 'getter should not be verified for 1');
        assert.strictEqual(context.mole.verify(function (_) { return _.getter; }, Times.exact(2)), false, 'getter should not be verified for 2');
        assert.strictEqual(context.mole.verify(function (_) { return _.getter; }, Times.exact(3)), false, 'getter should not be verified for 3');
        assert.strictEqual(context.mole.verify(function (_) { return _.getter; }, Times.exact(4)), true), 'getter should be verified for 4';
        assert.strictEqual(context.mole.verify(function (_) { return _.getter; }, Times.exact(5)), false, 'getter should not be verified for 5');
        assert.strictEqual(context.mole.verify(function (_) { return _.getter; }, Times.exact(6)), false, 'getter should not be verified for 6');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[0]; }), true, 'setter should be verified for argSet[0]');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[1]; }), true, 'setter should be verified for argSet[1]');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[2]; }), true, 'setter should be verified for argSet[2]');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[3]; }), false, 'setter should not be verified for argSet[3]');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[0]; }, Times.exact(0)), false, 'setter should not be verified for argSet[0] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[0]; }, Times.exact(1)), false, 'setter should not be verified for argSet[0] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[0]; }, Times.exact(2)), false, 'setter not should be verified for argSet[0] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[0]; }, Times.exact(3)), true, 'setter should be verified for argSet[0] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[0]; }, Times.exact(4)), false, 'setter should not be verified for argSet[0] 4 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[1]; }, Times.exact(0)), false, 'setter should not be verified for argSet[1] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[1]; }, Times.exact(1)), true, 'setter should be verified for argSet[1] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[1]; }, Times.exact(2)), false, 'setter should not be verified for argSet[1] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[1]; }, Times.exact(3)), false, 'setter should not be verified for argSet[1] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[2]; }, Times.exact(0)), false, 'setter should not be verified for argSet[2] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[2]; }, Times.exact(1)), false, 'setter should not be verified for argSet[2] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[2]; }, Times.exact(2)), false, 'setter should not be verified for argSet[2] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[2]; }, Times.exact(3)), true, 'setter should be verified for argSet[2] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[2]; }, Times.exact(4)), false, 'setter should not be verified for argSet[2] 4 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.setter = argSet[2]; }, Times.exact(5)), false, 'setter should not be verified for argSet[2] 5 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter; }), true, 'getterAndSetter getter should be verified');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter; }, Times.exact(0)), false, 'getterAndSetter getter should not be verified for 0');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter; }, Times.exact(1)), false, 'getterAndSetter getter should not be verified for 1');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter; }, Times.exact(2)), false, 'getterAndSetter getter should not be verified for 2');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter; }, Times.exact(3)), false, 'getterAndSetter getter should not be verified for 3');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter; }, Times.exact(4)), true), 'getterAndSetter getter should be verified for 4';
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter; }, Times.exact(5)), false, 'getterAndSetter getter should not be verified for 5');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter; }, Times.exact(6)), false, 'getterAndSetter getter should not be verified for 6');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[0]; }), true, 'getterAndSetter setter should be verified for argSet[0]');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[1]; }), true, 'getterAndSetter setter should be verified for argSet[1]');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[2]; }), true, 'getterAndSetter setter should be verified for argSet[2]');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[3]; }), false, 'getterAndSetter setter should not be verified for argSet[3]');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[0]; }, Times.exact(0)), false, 'getterAndSetter setter should not be verified for argSet[0] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[0]; }, Times.exact(1)), false, 'getterAndSetter setter should not be verified for argSet[0] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[0]; }, Times.exact(2)), false, 'getterAndSetter setter not should be verified for argSet[0] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[0]; }, Times.exact(3)), true, 'getterAndSetter setter should be verified for argSet[0] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[0]; }, Times.exact(4)), false, 'getterAndSetter setter should not be verified for argSet[0] 4 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[1]; }, Times.exact(0)), false, 'getterAndSetter setter should not be verified for argSet[1] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[1]; }, Times.exact(1)), true, 'getterAndSetter setter should be verified for argSet[1] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[1]; }, Times.exact(2)), false, 'getterAndSetter setter should not be verified for argSet[1] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[1]; }, Times.exact(3)), false, 'getterAndSetter setter should not be verified for argSet[1] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[2]; }, Times.exact(0)), false, 'getterAndSetter setter should not be verified for argSet[2] 0 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[2]; }, Times.exact(1)), false, 'getterAndSetter setter should not be verified for argSet[2] 1 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[2]; }, Times.exact(2)), false, 'getterAndSetter setter should not be verified for argSet[2] 2 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[2]; }, Times.exact(3)), true, 'getterAndSetter setter should be verified for argSet[2] 3 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[2]; }, Times.exact(4)), false, 'getterAndSetter setter should not be verified for argSet[2] 4 times');
        assert.strictEqual(context.mole.verify(function (_) { return _.getterAndSetter = argSet[2]; }, Times.exact(5)), false, 'getterAndSetter setter should not be verified for argSet[2] 5 times');
    });
    QUnit.test('verify - times returns false should return false', 1, function (assert) {
        ...
        var result = context.mole.verify(function (_) { return _.noArgumentsFunction(); }, timesMole);
    ...
    QUnit.test('verify - one argument - ItIsBase returns false should return false', 1, function (assert) {
        ...
        var result = context.mole.verify(function (_) { return _.oneArgumentsFunction(itIs); });
    ...
    QUnit.test('verify - many arguments - ItIsBase returns false should return false', 1, function (assert) {
        ...
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(itIs, itIs, itIs); });
        assert.strictEqual(result, false, 'should return false if ItIs returns false');
    });
    ...
    QUnit.test('verify - many arguments - ItIsBase returns true and false should return false', 1, function (assert) {
        ...
        context.testObject.manyArgumentsFunction(1, 1, 1);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(trueItIs, trueItIs, falseItIs); });
    ...
    QUnit.test('verify - many arguments - ItIsBase returns true and other arguments dont match should return false', 1, function (assert) {
        ...
        trueItIs.match = function () { return true; };
        context.testObject.manyArgumentsFunction(1, 1, 1);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(trueItIs, trueItIs, 2); });
    ...
    QUnit.test('verify - many arguments - called many times ItIsBase returns true should return true', 1, function (assert) {
        ...
        context.testObject.manyArgumentsFunction(1, 1, 1);
        context.testObject.manyArgumentsFunction(1, 1, 1);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(trueItIs, trueItIs, 2); }, Times.exact(2));
    ...
    QUnit.test('verify - many arguments - called many times ItIsBase returns true once should return true', 1, function (assert) {
        ...
        context.testObject.manyArgumentsFunction(1, 1, 1);
        context.testObject.manyArgumentsFunction(1, 1, 1);
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(1, trueItIs, 2); }, Times.exact(1));
        assert.strictEqual(result, true, 'should return true if ItIs returns true and the times match');
    });
    QUnit.test('verify - many arguments - called with numbers and strings should return only the strings', 1, function (assert) {
        ...
        var result = context.mole.verify(function (_) { return _.manyArgumentsFunction(numberItIs, stringItIs, numberItIs); }, Times.exact(2));
    ...
    QUnit.test('verify - setter - ItIsBase returns false should return false', 1, function (assert) {
        ...
        var result = context.mole.verify(function (_) { return _.setter = itIs; });
        assert.strictEqual(result, false, 'should return false if ItIs returns false');
    });
    ...
    QUnit.test('verify - getter&setter - setter - ItIsBase returns false should return false', 1, function (assert) {
        ...
        var result = context.mole.verify(function (_) { return _.getterAndSetter = itIs; });
        assert.strictEqual(result, false, 'should return false if ItIs returns false');
    });
    ...
    QUnit.test('verify - after setups should count ok', function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.getter; }).callback(function () { });
        context.testObject.getter;
        context.testObject.getter;
        context.testObject.getter;
        context.testObject.getter;
        context.mole.setup(function (_) { return _.oneArgumentsFunction(1); }).callback(function () { });
        context.mole.setup(function (_) { return _.oneArgumentsFunction(2); }).callback(function () { });
        context.mole.setup(function (_) { return _.oneArgumentsFunction(3); }).callback(function () { });
        context.testObject.oneArgumentsFunction(1);
        ...
        context.testObject.oneArgumentsFunction(4);
        context.testObject.oneArgumentsFunction(4);
        assert.strictEqual(context.mole.verify(function (_) { return _.getter; }, Times.exact(4)), true, 'should verify getter correctly');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(1); }, Times.exact(1)), true, 'should verify calling the function with parameter correctly');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(2); }, Times.exact(2)), true, 'should verify calling the function with parameter correctly');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(3); }, Times.exact(3)), true, 'should verify calling the function with parameter correctly');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(4); }, Times.exact(4)), true, 'should verify calling the function with parameter correctly');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(It.isAny(Number)); }, Times.exact(10)), true, 'should verify calling with any number correctly');
        assert.strictEqual(context.mole.verify(function (_) { return _.oneArgumentsFunction(It.isAny(Number)); }, Times.exact(11)), false, 'should verify calling with any number correctly');
    });
    ...
    QUnit.test('setup - callback - should not call callback if function is not called', 0, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).callback(function () {
    ...
    QUnit.test('setup - callback - should pass the same parameters', 1, function (assert) {
        var context = this;
        var arg = 1;
        context.mole.setup(function (_) { return _.oneArgumentsFunction(It.isAny(Number)); }).callback(function (_arg) {
    ...
    QUnit.test('setup - callback - should pass the same parameters 2', 3, function (assert) {
        ...
        var arg2 = 2;
        var arg3 = 3;
        context.mole.setup(function (_) { return _.manyArgumentsFunction(It.isAny(Number), It.isAny(Number), It.isAny(Number)); })
    ...
    QUnit.test('setup - callback - should pass the same parameters to setter', 1, function (assert) {
        var context = this;
        var arg = 1;
        context.mole.setup(function (_) { return _.setter = It.isAny(Number); }).callback(function (_arg) {
    ...
    QUnit.test('setup - callback - should pass the same parameters to setter of getter and setter', 1, function (assert) {
        var context = this;
        var arg = 1;
        context.mole.setup(function (_) { return _.getterAndSetter = It.isAny(Number); }).callback(function (_arg) {
    ...
    QUnit.test('setup - callback - should not call callbacks on other functions', 0, function (assert) {
        ...
        context.mole.setup(function (_) { return _.oneArgumentsFunction(It.isAny(Number)); }).callback(shouldNotHappen);
        context.mole.setup(function (_) { return _.manyArgumentsFunction(It.isAny(Number), It.isAny(Number), It.isAny(Number)); }).callback(shouldNotHappen);
        context.mole.setup(function (_) { return _.getter; }).callback(shouldNotHappen);
        context.mole.setup(function (_) { return _.setter = 1; }).callback(shouldNotHappen);
        context.mole.setup(function (_) { return _.getterAndSetter; }).callback(shouldNotHappen);
        context.mole.setup(function (_) { return _.getterAndSetter = 1; }).callback(shouldNotHappen);
        context.testObject.onNoArgumentsFunctionCalled = shouldNotHappen;
        context.testObject.manyArgumentsFunction = shouldNotHappen;
        context.testObject.oneArgumentsFunction = shouldNotHappen;
        context.testObject.onGetterCalled = shouldNotHappen;
    ...
    QUnit.test('setup - callback - should not call lazyReturns on other functions', 0, function (assert) {
        ...
        context.mole.setup(function (_) { return _.oneArgumentsFunction(It.isAny(Number)); }).lazyReturns(shouldNotHappen);
        context.mole.setup(function (_) { return _.manyArgumentsFunction(It.isAny(Number), It.isAny(Number), It.isAny(Number)); }).lazyReturns(shouldNotHappen);
        context.testObject.onNoArgumentsFunctionCalled = shouldNotHappen;
        context.testObject.manyArgumentsFunction = shouldNotHappen;
        context.testObject.oneArgumentsFunction = shouldNotHappen;
        context.testObject.noArgumentsFunction();
    ...
    QUnit.test('setup - callback - should not return the callback return value', 1, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.returning1Function(); }).callback(function () {
            return {};
        });
    ...
    QUnit.test('setup - callback - should pass teh same parameters to all the callbacks when function is called', 4, function (assert) {
        ...
        context.mole.setup(function (_) { return _.oneArgumentsFunction(It.isAny(Number)); })
    ...
    QUnit.test('setup - callback - should not affect verify', 1, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).callback(function () { });
        assert.ok(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(0)), 'should not effect verify');
    });
    QUnit.test('setup - callback - should not affect verify for getter', 1, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.getter; }).callback(function () { });
        assert.ok(context.mole.verify(function (_) { return _.getter; }, Times.exact(0)), 'should not effect verify');
    });
    QUnit.test('setup - callback - should not affect verify for setter', 1, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.setter = 1; }).callback(function () { });
        assert.ok(context.mole.verify(function (_) { return _.setter = 1; }, Times.exact(0)), 'should not effect verify');
    });
    QUnit.test('setup - callback - should not affect verify for getter of getter and setter', 1, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.getterAndSetter; }).callback(function () { });
        assert.ok(context.mole.verify(function (_) { return _.getterAndSetter; }, Times.exact(0)), 'should not effect verify');
    });
    QUnit.test('setup - callback - should not affect verify for setter of getter and setter', 1, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.getterAndSetter = 1; }).callback(function () { });
        assert.ok(context.mole.verify(function (_) { return _.getterAndSetter = 1; }, Times.exact(0)), 'should not effect verify');
    });
    ...
    QUnit.test('setup - returns - should not call the original function', 0, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).returns(111);
        context.testObject.onNoArgumentsFunctionCalled = function () {
            assert.ok(false, 'should not call the original function');
        };
        context.testObject.noArgumentsFunction();
    ...
    QUnit.test('setup - returns - should not call the original getter', 0, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.getter; }).returns(111);
        context.testObject.onGetterCalled = function () {
            assert.ok(false, 'should not call the original function');
        };
        context.testObject.getter;
    ...
    QUnit.test('setup - returns - should not call the original getter of getter and setter', 0, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.getterAndSetter; }).returns(111);
        context.testObject.onGetterOfGetterAndSetterCalled = function () {
            assert.ok(false, 'should not call the original function');
        };
        context.testObject.getterAndSetter;
    ...
    QUnit.test('setup - returns - should return the value', 1, function (assert) {
        var context = this;
        var returnValue = {};
        context.mole.setup(function (_) { return _.returning1Function(); }).returns(returnValue);
        var result = context.testObject.returning1Function();
    ...
    QUnit.test('setup - returns - should return the value for getter', 1, function (assert) {
        var context = this;
        var returnValue = {};
        context.mole.setup(function (_) { return _.getter; }).returns(returnValue);
    ...
    QUnit.test('setup - returns - should return the value for getter and setter', 1, function (assert) {
        var context = this;
        var returnValue = {};
        context.mole.setup(function (_) { return _.getterAndSetter; }).returns(returnValue);
        var result = context.testObject.getterAndSetter;
        assert.strictEqual(result, returnValue, 'should return the configured value');
    });
    QUnit.test('setup - returns - should return the last returns value', 1, function (assert) {
        ...
        var returnValue3 = {};
        var returnValue4 = {};
        context.mole.setup(function (_) { return _.returning1Function(); }).returns(returnValue1);
        context.mole.setup(function (_) { return _.returning1Function(); }).returns(returnValue2);
        context.mole.setup(function (_) { return _.returning1Function(); }).returns(returnValue3);
        context.mole.setup(function (_) { return _.returning1Function(); }).returns(returnValue4);
        var result = context.testObject.returning1Function();
    ...
    QUnit.test('setup - returns - should not affect verify', 1, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).returns(4);
        assert.ok(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(0)), 'should not effect verify');
    });
    ...
    QUnit.test('setup - returns - calling with not matching argument should return the original', 1, function (assert) {
        var context = this;
        var returnValue = {};
        context.mole.setup(function (_) { return _.oneArgumentsFunction(1); }).returns(returnValue);
    ...
    QUnit.test('setup - returnsInOrder - should not call the original function', 0, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).returnsInOrder([111]);
        context.testObject.onNoArgumentsFunctionCalled = function () {
            assert.ok(false, 'should not call the original function');
        };
        context.testObject.noArgumentsFunction();
    ...
    QUnit.test('setup - returnsInOrder - should return the values', 4, function (assert) {
        ...
        var returnValue2 = {};
        var returnValue3 = {};
        context.mole.setup(function (_) { return _.returning1Function(); }).returnsInOrder([returnValue1, returnValue2, returnValue3]);
    ...
    QUnit.test('setup - returnsInOrder - should return the last returns values', 4, function (assert) {
        ...
        var returnValue7 = {};
        context.mole.setup(function (_) { return _.returning1Function(); }).returns(returnValue1);
        context.mole.setup(function (_) { return _.returning1Function(); }).returnsInOrder([returnValue2, returnValue3, returnValue4]);
        context.mole.setup(function (_) { return _.returning1Function(); }).returnsInOrder([returnValue5, returnValue6, returnValue7]);
        var result1 = context.testObject.returning1Function();
        var result2 = context.testObject.returning1Function();
        var result3 = context.testObject.returning1Function();
        var result4 = context.testObject.returning1Function();
    ...
    QUnit.test('setup - returnsInOrder - should not affect verify', 1, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).returnsInOrder([4]);
        assert.ok(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(0)), 'should not effect verify');
    });
    QUnit.test('setup - returnsInOrder - should return the last returns values for getter', 4, function (assert) {
        ...
        var returnValue6 = {};
        var returnValue7 = {};
        context.mole.setup(function (_) { return _.getter; }).returns(returnValue1);
        context.mole.setup(function (_) { return _.getter; }).returnsInOrder([returnValue2, returnValue3, returnValue4]);
        context.mole.setup(function (_) { return _.getter; }).returnsInOrder([returnValue5, returnValue6, returnValue7]);
    ...
    QUnit.test('setup - lazyReturns - should not call returnFunction if function is not called', 0, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).lazyReturns(function () {
    ...
    QUnit.test('setup - lazyReturns - should pass the same parameters', 1, function (assert) {
        var context = this;
        var arg = 1;
        context.mole.setup(function (_) { return _.oneArgumentsFunction(It.isAny(Number)); }).lazyReturns(function (_arg) {
            assert.strictEqual(_arg, arg, 'should return same argument');
        });
        context.testObject.oneArgumentsFunction(arg);
    });
    ...
    QUnit.test('setup - lazyReturns - should return the returnFunction return value', 1, function (assert) {
        var context = this;
        var returnValue = {};
        context.mole.setup(function (_) { return _.returning1Function(); }).lazyReturns(function () {
            return returnValue;
        });
        var result = context.testObject.returning1Function();
    ...
    QUnit.test('setup - lazyReturns - should return the last returnFunction return value', 1, function (assert) {
        ...
        var returnValue3 = {};
        var returnValue4 = {};
        context.mole.setup(function (_) { return _.returning1Function(); })
    ...
    QUnit.test('setup - lazyReturns - should not affect verify', 1, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).lazyReturns(function () { return 4; });
        assert.ok(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(0)), 'should not effect verify');
    });
    QUnit.test('setup - lazyReturns - should return the last returnFunction return of getter of getter and setter', 1, function (assert) {
        ...
        var returnValue3 = {};
        var returnValue4 = {};
        context.mole.setup(function (_) { return _.getterAndSetter; })
            .lazyReturns(function () { return returnValue1; })
            .lazyReturns(function () { return returnValue2; })
            .lazyReturns(function () { return returnValue3; })
            .lazyReturns(function () { return returnValue4; });
    ...
    QUnit.test('setup - lazyReturnsInOrder - should not call returnFunction if function is not called', 0, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).lazyReturnsInOrder([function () {
                assert.ok(false, 'should not call returnFunction');
            }]);
    });
    QUnit.test('setup - lazyReturnsInOrder - should call returnFunction when function is called', 4, function (assert) {
        ...
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).lazyReturnsInOrder([
    ...
    QUnit.test('setup - lazyReturnsInOrder - should pass the same parameters', 2, function (assert) {
        ...
        var arg1 = 1;
        var arg2 = 2;
        context.mole.setup(function (_) { return _.oneArgumentsFunction(It.isAny(Number)); }).lazyReturnsInOrder([function (_arg1) {
                assert.strictEqual(_arg1, arg1, 'should return same argument');
            }, function (_arg2) {
                assert.strictEqual(_arg2, arg2, 'should return same argument');
            }]);
    ...
    QUnit.test('setup - lazyReturnsInOrder - should return the returnFunction return values', 4, function (assert) {
        ...
        var returnValue2 = {};
        var returnValue3 = {};
        context.mole.setup(function (_) { return _.returning1Function(); }).lazyReturnsInOrder([
    ...
    QUnit.test('setup - lazyReturnsInOrder - should not affect verify', 1, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).lazyReturnsInOrder([function () { return 4; }]);
        assert.ok(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(0)), 'should not effect verify');
    });
    ...
    QUnit.test('setup - throws - should not call the original function', 0, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).throws(111);
        context.testObject.onNoArgumentsFunctionCalled = function () {
            assert.ok(false, 'should not call the original function');
        };
        try {
    ...
    QUnit.test('setup - throws - should throw the error', 1, function (assert) {
        var context = this;
        var thrownError = {};
        context.mole.setup(function (_) { return _.returning1Function(); }).throws(thrownError);
        try {
    ...
    QUnit.test('setup - throws - should throw the last error for getter', 1, function (assert) {
        ...
        var thrownError3 = {};
        var thrownError4 = {};
        context.mole.setup(function (_) { return _.getter; })
            .throws(thrownError1)
            .throws(thrownError2)
            .throws(thrownError3)
            .throws(thrownError4);
    ...
    QUnit.test('setup - throws - should throw the last error for setter', 1, function (assert) {
        ...
        var thrownError3 = {};
        var thrownError4 = {};
        context.mole.setup(function (_) { return _.setter = 1; })
            .throws(thrownError1)
            .throws(thrownError2)
            .throws(thrownError3)
            .throws(thrownError4);
    ...
    QUnit.test('setup - throws - should throw the last error for setter of getter and setter', 1, function (assert) {
        ...
        var thrownError3 = {};
        var thrownError4 = {};
        context.mole.setup(function (_) { return _.getterAndSetter = 1; })
            .throws(thrownError1)
            .throws(thrownError2)
            .throws(thrownError3)
            .throws(thrownError4);
    ...
    QUnit.test('setup - throws - should not affect verify', 1, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).throws('error');
        assert.ok(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(0)), 'should not effect verify');
    });
    ...
    QUnit.test('setup - throws - calling setter with not matching argument should not throw', 0, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.setter = 1; }).throws({});
        try {
    ...
    QUnit.test('setup - throws - calling setter of getter and setter with not matching argument should not throw', 0, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.getterAndSetter = 1; }).throws({});
        try {
    ...
    QUnit.test('setup - throws - calling function with not matching argument should not throw', 0, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.oneArgumentsFunction(1); }).throws({});
        try {
            context.testObject.oneArgumentsFunction(2);
        }
        catch (e) {
    ...
    QUnit.test('setup - lazyThrows - should not call returnErrorFunction if function is not called', 0, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).lazyThrows(function () {
            assert.ok(false, 'should not call returnFunction');
        });
    });
    ...
    QUnit.test('setup - lazyThrows - should pass the same parameters', 1, function (assert) {
        var context = this;
        var arg = 1;
        context.mole.setup(function (_) { return _.oneArgumentsFunction(It.isAny(Number)); }).lazyThrows(function (_arg) {
            assert.strictEqual(_arg, arg, 'should return same argument');
        });
        try {
            context.testObject.oneArgumentsFunction(arg);
    ...
    QUnit.test('setup - lazyThrows - should throw the returnErrorFunction error', 1, function (assert) {
        var context = this;
        var error = {};
        context.mole.setup(function (_) { return _.returning1Function(); }).lazyThrows(function () {
            return error;
        });
        try {
            context.testObject.returning1Function();
    ...
    QUnit.test('setup - lazyThrows - should not affect verify', 1, function (assert) {
        var context = this;
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).lazyThrows(function () { return 4; });
        assert.ok(context.mole.verify(function (_) { return _.noArgumentsFunction(); }, Times.exact(0)), 'should not effect verify');
    });
    ...
    QUnit.test('setup - mix - should not affect the verify', 1, function (assert) {
        ...
        context.mole.setup(function (_) { return _.returning1Function(); })
            ...
            .returns(returnValue)
            .callback(function () { });
        assert.ok(context.mole.verify(function (_) { return _.returning1Function(); }, Times.exact(0)), 'should be called once');
    });
    QUnit.test('setup - mix - should call only the matching set', 3, function (assert) {
        ...
        context.mole.setup(function (_) { return _.oneArgumentsFunction('aaa'); })
            .throws('error')
            .lazyReturns(function () {
        ...
        context.mole.setup(function (_) { return _.oneArgumentsFunction('bbb'); })
            .lazyReturns(function () {
    ...
    QUnit.test('setup - mix - if both setups match should call both', 4, function (assert) {
        ...
        context.mole.setup(function (_) { return _.oneArgumentsFunction(1); })
            .lazyReturns(function () {
            assert.ok(true, 'should call');
        })
            .returns('return value')
    ...
    QUnit.test('setup - mix - setup for one object should not affect other', 5, function (assert) {
        ...
        mole1.setup(function (_) { return _.oneArgumentsFunction(It.isAny(Number)); }).callback(function (_arg) {
    ...
    QUnit.test('setupPrivate - callback - should pass the same parameters', 1, function (assert) {
        var context = this;
        var arg = 1;
        context.mole.setupPrivate(TestObject.PRIVATE_FUNCTION_NAME, It.isAny(Number)).callback(function (_arg) {
            assert.strictEqual(_arg, arg, 'should return same argument');
        });
        context.testObject.callPrivateFunction(arg);
    });
    ...
    QUnit.test('setupPrivate - callback - should not call if not matching', 0, function (assert) {
        var context = this;
        var arg = 'some text';
        context.mole.setupPrivate(TestObject.PRIVATE_FUNCTION_NAME, It.isAny(Number)).callback(function () {
            assert.ok(false, 'should not be called');
        });
        context.testObject.callPrivateFunction(arg);
    });
    ...
    QUnit.test('setupPrivate - callback - should not call setter if not matching', 0, function (assert) {
        var context = this;
        var arg = 'some text';
        context.mole.setupPrivate(TestObject.PRIVATE_SETTER_NAME, It.isAny(Number)).callback(function () {
            assert.ok(false, 'should not be called');
        });
    ...
    QUnit.test('setupPrivate - callback - should not call setter of getter&setter if not matching', 0, function (assert) {
        var context = this;
        var arg = 'some text';
        context.mole.setupPrivate(TestObject.PRIVATE_GETTER_AND_SETTER_NAME, It.isAny(Number)).callback(function () {
            assert.ok(false, 'should not be called');
        });
    ...
    QUnit.test('setupPrivate - callback - should not call lazyReturns on other functions', 0, function (assert) {
        var context = this;
        context.mole.setupPrivate(TestObject.PRIVATE_FUNCTION_NAME, 1).callback(function () { });
        var shouldNotHappen = function () {
            assert.ok(false, 'should not call the original function');
        };
        context.mole.setup(function (_) { return _.oneArgumentsFunction(It.isAny(Number)); }).lazyReturns(shouldNotHappen);
    ...
    QUnit.test('setupPrivate - lazyReturns - should not call returnFunction if function is not called', 0, function (assert) {
        var context = this;
        context.mole.setupPrivate(TestObject.PRIVATE_FUNCTION_NAME, 1).lazyReturns(function () {
            assert.ok(false, 'should not call returnFunction');
        });
    });
    ...
    QUnit.test('setupPrivate - lazyReturns - should pass the same parameters', 1, function (assert) {
        var context = this;
        var arg = 1;
        context.mole.setupPrivate(TestObject.PRIVATE_FUNCTION_NAME, It.isAny(Number)).lazyReturns(function (_arg) {
            assert.strictEqual(_arg, arg, 'should return same argument');
        });
        context.testObject.callPrivateFunction(arg);
    });
    ...
    QUnit.test('isStrict - true - has returns setup should return the returnValue and not throw error', 1, function (assert) {
        ...
        context.mole.isStrict = true;
        var returnValue = {};
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).returns(returnValue);
        try {
            var result = context.testObject.noArgumentsFunction();
            assert.strictEqual(result, returnValue, 'should return the return value');
        }
    ...
    QUnit.test('isStrict - true - has throws setup should throw the thrownError', 1, function (assert) {
        ...
        context.mole.isStrict = true;
        var thrownError = {};
        context.mole.setup(function (_) { return _.noArgumentsFunction(); }).throws(thrownError);
        try {
            context.testObject.noArgumentsFunction();
        }
        catch (error) {
    ...
    QUnit.test('staticFunction - Override static function', 1, function (assert) {
        var context = this;
        var mole = new Mole(TestObject);
        mole.setup(function (_) { TestObject.staticFunction(); }).callback(function () {
            assert.ok(true, 'should call callback');
        });
